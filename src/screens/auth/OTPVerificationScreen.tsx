...
const styles = StyleSheet.create({
  ...
  back: { paddingTop: 60, paddingHorizontal: 24 },
  backText: { color: '#7C3AED', fontSize: 16 },
  content: { flex: 1, paddingHorizontal: 24, justifyContent: 'center', marginTop: -80 },
  emoji: { fontSize: 48, marginBottom: 16 },
  title: { fontSize: 28, fontWeight: '700', color: '#ffffff', marginBottom: 8 },
  subtitle: { fontSize: 15, color: '#9ca3af', lineHeight: 22, marginBottom: 40 },
  email: { color: '#7C3AED', fontWeight: '600' },
  otpRow: { flexDirection: 'row', gap: 10, marginBottom: 24, justifyContent: 'center' },
  otpBox: { width: 48, height: 56, borderRadius: 12, borderWidth: 1.5, borderColor: '#2a2a2a', backgroundColor: '#1a1a1a', color: '#ffffff', fontSize: 24, fontWeight: '700', textAlign: 'center' },
  ...
  button: { backgroundColor: '#7C3AED', borderRadius: 14, padding: 16, alignItems: 'center', marginBottom: 20 },
  buttonDisabled: { opacity: 0.6 },
  buttonText: { color: '#ffffff', fontSize: 16, fontWeight: '600' },
  resendRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
  resendLabel: { color: '#9ca3af', fontSize: 14 },
  resendLink: { color: '#7C3AED', fontSize: 14, fontWeight: '600' },
  resendCountdown: { color: '#6b7280', fontSize: 14 },
});